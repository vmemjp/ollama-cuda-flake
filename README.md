...
A Nix flake that builds [Ollama v0.17.0](https://github.com/ollama/ollama/releases/tag/v0.17.0) from source with CUDA support, optimized for SM_89 (RTX 40-series) GPUs on x86_64 Linux.
